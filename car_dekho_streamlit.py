...
model = joblib.load(r"C:\Users\kirub\new_car_dekho\final_random_forest_model1.pkl")
label_encoders = joblib.load(r"C:\Users\kirub\new_car_dekho\label_encoder.pkl")
scalers = joblib.load(r"C:\Users\kirub\new_car_dekho\min_max.pkl")  # Assuming this is your loaded scaler for inverse transformation

# Load dataset for filtering and identifying similar data
data = pd.read_csv(r"C:\Users\kirub\new_car_dekho\cleaned_cardata.csv")
...
#car image path
car_image_path="https://wallpapers.com/images/hd/black-car-4k-wnfjwxcbybpwbs08.jpg"
